...
fn create_source(form: &Form) -> std::result::Result<Option<Value>, String> {
...
struct Field {
    ...
    only_for: Vec<(&'static str, &'static str)>,
}
...
impl Field {
    ...
    fn when(mut self, switch: &'static str, tags: &'static str) -> Self {
...
impl App {
    ...
    fn new_service_form(&mut self, req: &Sender<Req>) {
